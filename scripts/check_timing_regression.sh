...
#
# pocket: no upstream counterpart, the core never closes timing, so the only useful
# check is a ratchet against timing_baseline.txt.
set -euo pipefail

STA="${1:-projects/output_files/megadrive_pocket.sta.summary}"
